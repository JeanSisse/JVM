#include <stdint.h>
	...
	#define NUM_INSTRUC		255 //DEFINE 255 POSIÇÕES NO ARRAY DE INSTRUÇÕES
	...
	EXT_LEITOR void pega_operandos(decoder decode[], FILE *fp, int opcode, AT_Code **att_code, uint32_t *i);
